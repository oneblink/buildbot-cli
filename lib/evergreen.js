...
// assumeAWSRole (project: string) => Promise<Object>
function assumeAWSRole (project, platforms) {
...
function upload (zipPath, tenant, project, credentials) {
  ...
  return s3UploaderFactory(constants.BUILDBOT.EVERGREEN_BUCKET_NAME, key, zipPath, credentials, true)
